    ...
    if(array) {
        ...
        for(i = 0; i < array.length; i++) {
            ...
            if(array[i].title.substring(0, val.length).toUpperCase() === val.toUpperCase()) {
                ...
                b.innerHTML = "<strong>" + array[i].original_title.substring(0, val.length) + "</strong>";
                ...
                b.innerHTML += "<input type='hidden' value='" + array[i].original_title + "'>"
        ...
        input.addEventListener("keyup", function(e) {fired = false});
