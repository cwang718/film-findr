...
export default function autocomplete(input, array) {
  if (array) {
    ...
    for (i = 0; i < array.length; i++) {
      ...
      if (
        array[i].title.substring(0, val.length).toUpperCase() ===
        val.toUpperCase()
      ) {
        //Make div for matching element
        b = document.createElement("div");
        b.setAttribute("data-mid", array[i].id);
        //Make matching letters bold
        b.innerHTML =
          "<strong>" +
          array[i].original_title.substring(0, val.length) +
          "</strong>";
        ...
        b.innerHTML +=
          "<input type='hidden' value='" + array[i].original_title + "'>";
        ...
        b.addEventListener("click", function (e) {
          ...
          closeAllLists();
          //Sets data-mid with the movie id
          // Searchbar.setMovieId(this.getAttribute("data-mid"));
          console.log(this.children[1].getAttribute("data-mid"));
      ...
      if (!fired) {
        ...
        if (e.keyCode === 40) {
          ...
          if (curFocus > -1) {
            ...
            if (x) {
              x[curFocus].click();
              console.log(x[curFocus].children[1].getAttribute("data-mid"));
